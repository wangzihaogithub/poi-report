 ...
 * 对原生poi的扩展
 * 
 * @see #merge(Iterator, XWPFParagraph) 原生的没有这个方法, 专门加的 wangzihao 2020年11月25日
 * @author Sayi
 * @version 0.0.1
 *
 */
public class NiceXWPFDocument extends XWPFDocument {
    ...
    private static Logger logger = LoggerFactory.getLogger(com.deepoove.poi.xwpf.NiceXWPFDocument.class);
    ...
    public com.deepoove.poi.xwpf.NiceXWPFDocument generate() throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        this.write(byteArrayOutputStream);
        this.close();
        return new com.deepoove.poi.xwpf.NiceXWPFDocument(new ByteArrayInputStream(byteArrayOutputStream.toByteArray()));
    }

    public com.deepoove.poi.xwpf.NiceXWPFDocument generateWithAdjust() throws IOException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        this.write(byteArrayOutputStream);
        this.close();
        return new com.deepoove.poi.xwpf.NiceXWPFDocument(new ByteArrayInputStream(byteArrayOutputStream.toByteArray()), true);
    }
     ...
     * @since 1.3.0
     */
    public com.deepoove.poi.xwpf.NiceXWPFDocument merge(com.deepoove.poi.xwpf.NiceXWPFDocument docMerge) throws Exception {
     ...
     * @since 1.3.0
     */
    public com.deepoove.poi.xwpf.NiceXWPFDocument merge(List<com.deepoove.poi.xwpf.NiceXWPFDocument> docMerges, XWPFRun run) throws Exception {
        if (null == docMerges || docMerges.isEmpty() || null == run) return this;
        return merge(docMerges.iterator(), run);
    }

    public com.deepoove.poi.xwpf.NiceXWPFDocument merge(Iterator<com.deepoove.poi.xwpf.NiceXWPFDocument> iterator, XWPFRun run) throws Exception {
        if (null == iterator || !iterator.hasNext() || null == run) return this;
        // XWPFParagraph paragraph = insertNewParagraph(run);
        XWPFParagraph paragraph = (XWPFParagraph) run.getParent();
        return merge(iterator,paragraph);
    }

    public com.deepoove.poi.xwpf.NiceXWPFDocument merge(Iterator<NiceXWPFDocument> iterator, XWPFParagraph paragraph) throws Exception {
        if (null == iterator || !iterator.hasNext()) return this;
        // XWPFParagraph paragraph = insertNewParagraph(run);
